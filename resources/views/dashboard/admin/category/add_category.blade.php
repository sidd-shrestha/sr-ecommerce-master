                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.create_category') }}" method="post" autocomplete="off"
                                ...
                                <select class="form-control" style="color: white" name="groups_id">
                                    @foreach ($groups as $groups)
                                        <option value="{{ $groups->id }}">{{ $groups->category_name }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <button type="submit" class="btn btn-outline-primary btn-md">Add Category</button>
                            </form>
                        </div>
                    </div>
                </div>
