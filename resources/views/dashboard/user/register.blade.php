      ...
      <div class="container">
          <div class="row">
              <div class="col-lg-6 offset-lg-3 col-md-10 offset-md-1 col-12">
                <form action="{{ route('user.create') }}"  class="card login-form" method="post" autocomplete="off">
                  ...
                  @csrf
                      ...
                      <div class="card-body">
                          ...
                          <p class="outer-link">Don't have an account? <a href="{{route('user.login')}}">Login </a>
                          </p>
                      </div>
                  </form>
              </div>
