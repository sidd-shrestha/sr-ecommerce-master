            ...
            <div class="col-lg-3 col-12">
                ...
                <div class="product-sidebar">
                    ...
                    <div class="single-widget">
                        ...
                        <ul class="list">
                            <li>
                                <a href="product-grids.html">Classic </a><span>(10)</span>
                            </li>
                            <li>
                                <a href="product-grids.html">Stylish</a><span>(20)</span>
                            </li>
                            <li>
                                <a href="product-grids.html">Modern</a><span>(33)</span>
                            </li>
                            <!-- <li>
                            ...
                            <div class="col-lg-7 col-md-8 col-12">
                                <div class="product-sorting">
                                    ...
                                    <select class="form-control" id="sorting">
                                        <option> <a href="{{URL::current()."sort=popularity"}}">Popularity</a> </option>
                                        <option> <a href="{{URL::current()."sort=price_asc"}}">Low - High Price</a></option>
                                        <option> <a href="{{URL::current()."sort=price_desc"}}">High - Low Price</a></option>
                                        <option> <a href="{{URL::current()."sort=newest"}}">Newest</a> </option>
                                        <option> <a href="{{URL::current()}}">Average Rating</a></option>
                                        <option> <a href="{{URL::current()}}">A - Z Order</a></option>
                                        <option> <a href="{{URL::current()}}">Z - A Order</a></option>
                                    </select>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    ...
                                    <div class="single-product">
                                        ...
                                        <div class="product-info">
                                            <span class="category">{{$product->subcategory->brand_name}}</span>
                                            <h4 class="title">
                                                <a href="{{url('/user/viewdetails/'. $product->slug)}}">{{$product->product_name}}</a>
                                            </h4>
                                            <ul class="review">
                                            ...
                                            <div class="price">
                                                <span>Rs {{$product->offer_price}}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- End Single Product -->
